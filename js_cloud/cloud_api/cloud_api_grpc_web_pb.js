...
const methodDescriptor_UserService_UpdateNamespace = new grpc.web.MethodDescriptor(
  '/CloudApi.UserService/UpdateNamespace',
  grpc.web.MethodType.UNARY,
  proto.CloudApi.ApiRequest,
  proto.CloudApi.ApiResponse,
  /**
 ...
 *     The XHR Node Readable Stream
 */
proto.CloudApi.UserServiceClient.prototype.updateNamespace =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/CloudApi.UserService/UpdateNamespace',
      request,
 ...
 *     Promise that resolves to the response
 */
proto.CloudApi.UserServicePromiseClient.prototype.updateNamespace =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/CloudApi.UserService/UpdateNamespace',
      request,
